document.addEventListener('DOMContentLoaded', ()=>{
  ...
  form.addEventListener('submit', (e)=>{
    ...
    if(!newName || !newEmail){ alert('Isi nama & email'); return; }
    ...
    if(newEmail !== oldEmail){
      // move profile
      profiles[newEmail] = { name:newName, email:newEmail, target:newTarget };
      // remove old profile
    ...
    profiles[oldEmail] = { name:newName, email:oldEmail, target:newTarget };
    saveProfiles(profiles);
